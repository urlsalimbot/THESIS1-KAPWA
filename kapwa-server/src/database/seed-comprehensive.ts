...
async function seed() {
  ...
  await q.query(`
    ...
    VALUES
      ('${ID.b_alcala}',    'PHIL-9876-5432-1001','Alcala',    'Rodolfo',  'Garcia',  'Male',   '1973-04-12','123 Purok 1, Bigte, Norzagaray',       '09171234501','NORZ-AC-2025-0001','active','Senior Citizen'),
      ('${ID.b_roxas}',     'PHIL-9876-5432-1002','Roxas',     'Teresita', 'Mendoza', 'Female', '1968-11-03','456 Purok 2, Bigte, Norzagaray',       '09171234502','NORZ-AC-2025-0002','active','Senior Citizen'),
      ('${ID.b_cruz}',      'PHIL-9876-5432-1003','Cruz',      'Antonio',  'Lopez',   'Male',   '1982-07-21','789 Purok 3, Matictic, Norzagaray',    '09171234503','NORZ-AC-2025-0003','active','Family'),
      ('${ID.b_santos}',    'PHIL-9876-5432-1004','Santos',    'Elena',    'Rivera',  'Female', '1990-02-14','101 Purok 4, Matictic, Norzagaray',    '09171234504','NORZ-AC-2025-0004','active','Women'),
      ('${ID.b_garcia}',    'PHIL-9876-5432-1005','Garcia',    'Francisco','Aquino',  'Male',   '1995-09-08','202 Purok 1, Partida, Norzagaray',     '09171234505','NORZ-AC-2025-0005','active','Youth'),
      ('${ID.b_reyes}',     'PHIL-9876-5432-1006','Reyes',     'Carmen',   'Villanueva','Female','1988-06-30','303 Purok 2, Partida, Norzagaray',     '09171234506','NORZ-AC-2025-0006','active','PWD'),
      ('${ID.b_mendoza}',   'PHIL-9876-5432-1007','Mendoza',   'Ricardo',  'Fernando','Male',   '1960-01-15','404 Purok 1, San Mateo, Norzagaray',   '09171234507','NORZ-AC-2025-0007','active','Senior Citizen'),
      ('${ID.b_aquino}',    'PHIL-9876-5432-1008','Aquino',    'Sofia',    'Dela Cruz','Female','1998-12-25','505 Purok 2, San Mateo, Norzagaray',   '09171234508','NORZ-AC-2025-0008','active','Youth'),
