    ...
    <div className="max-w-xl space-y-6">
      ...
      {assignedCode && (
        <Card className="border-emerald-200 bg-emerald-50">
          <CardContent className="p-4">
            <p className="text-sm font-medium text-emerald-800">{t('accessCard.cardAssigned', 'Card assigned!')}</p>
            <p className="text-xs text-emerald-700 mt-1">{t('accessCard.codeLabel', 'Code: {{code}}', { code: assignedCode })}</p>
          </CardContent>
        </Card>
      )}
