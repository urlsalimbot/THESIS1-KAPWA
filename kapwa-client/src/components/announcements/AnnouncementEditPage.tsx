...
export function AnnouncementEditPage() {
  ...
  const excerptHint = `${excerpt.length}/160 characters`;

  return (
    <PageShell
      title={isNew ? 'New Announcement' : 'Edit Announcement'}
      description={isNew ? 'Draft and publish a public announcement.' : 'Update this announcement.'}
      backTo={{ label: 'Announcements', onClick: () => navigate('/announcements/manage') }}
    >
          ...
          <CardContent className="space-y-5 pt-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g. Barangay Cleanup Drive Schedule"
                className="text-base"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Short summary shown on the public website"
                rows={2}
              />
            </div>
        ...
        <div className="flex items-center justify-between">
          {isNew ? (
            <p className="text-xs text-muted-foreground inline-flex items-center gap-1.5">
              <Megaphone size={13} />
              Announcements appear on the public home page once published.
            </p>
          ) : (
